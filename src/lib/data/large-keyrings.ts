...
export interface KeyringSegment {
  id: string;
  title: string;
  shortTitle: string;
  color: string;
  bgTint: string;
  rows: KeyringRow[]; // always 14 rows
}
...
export const KEYRING_SEGMENTS: KeyringSegment[] = [
  {
    id: "zoo",
    title: "Zoo Animals",
    shortTitle: "Zoo Animals",
    ...
    rows: [
      ...
      [p("Purple Elephant",       "Purple_Elephant.jpeg"),    p("Tortoise",            "Tortoise.jpeg"),           p("Red Panda Walking",     "Red_Panda_Face.png")],
  ...
  },
  {
    ...
    rows: [
      ...
      [p("Brown Stingray",        "Brown_Stingray.png"),      p("Blue Tang",           "Blue_Shark.png"),          p("Crab",                  "Crab.png")],
  ...
  },
  {
    ...
    rows: [
      ...
      [p("Unicorn Body",          "Unicorn_Body.png"),        p("Gun",                 "Skull.png"),               p("Spinosaurus",           "Spinosaurus.png")],
      [p("Teddy",                 "Teddy.png"),               p("Diplodocus",          "Diplodocus.jpeg"),         p("Yellow Spinosaurus",    "Spinosaurus.png")],
      ...
      [p("Loch Ness",             "Loch_Ness.png"),           p("Stegosaurus",         "Stegosaurus.jpeg"),        p("Scottish Yellow Flag",  "Scottish_Flag.png")],
      ...
      [p("Nessie in Water",       "Loch_Ness.png"),           p("Orange Triceratops",  "Orange_Triceratops.png"),  p("Scotty Dog",            "Scotty_Dog.jpeg")],
    ],
  },
  {
