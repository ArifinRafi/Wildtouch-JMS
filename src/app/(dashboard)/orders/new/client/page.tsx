  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-base font-semibold">Choose client & delivery address</p>
        <p className="text-sm text-muted-foreground mt-1 max-w-md">
          Select a saved client; their invoice and delivery addresses auto-fill here. (Phase 4)
        </p>
      </motion.div>

      <StepNav backHref="/orders/new/inventory" nextHref="/orders/new/review" />
    </div>
  );
}
