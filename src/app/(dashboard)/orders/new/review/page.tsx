  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-base font-semibold">Review &amp; confirm</p>
        <p className="text-sm text-muted-foreground mt-1 max-w-md">
          Final summary with totals. Confirming deducts stock and generates the invoice. (Phase 5)
        </p>
      </motion.div>

      <StepNav backHref="/orders/new/client" isLast nextLabel="Confirm Order" nextDisabled />
    </div>
  );
}
